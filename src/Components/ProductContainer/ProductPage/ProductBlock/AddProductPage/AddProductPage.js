...
class AddProductPage extends React.Component {
	...
	onHandleElements = () => {
		...
		const pickedDate = new Intl.DateTimeFormat("en-GB", DateOptions).format(
			this.expireDate.current.valueAsDate
		);
						...
						<div className="expire-stock">
							<div className="form-group mb-3 col-xs-12 col-sm-6 expire">
								...
								<input
									...
									name="expire_date"
									type="date"
									className="expire_date form-control"
								/>
							</div>
